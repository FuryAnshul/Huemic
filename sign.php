                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="3000">
                            <a href="" style="text-decoration: none; color: aliceblue;"><span
                                    ...
                                    <small>FLAT 10% OFF ON YOUR 1ST APP PURCHASE</small>
                                </span></a>
                        ...
                        <div class="carousel-item" data-bs-interval="3000">
                            <a href="#" style="text-decoration: none; color: aliceblue;"><span
                                    style="letter-spacing: 3px; font-weight: 700;">
                                    <small>FLAT 40% OFF ON SELECT COLLECTION</small>
                                </span></a>
                            <a href="#" class="link-light"><span style="font-size: 14px; font-weight: 400;">
                        ...
                        <div class="carousel-item" data-bs-interval="3000">
                            <a href="#" style="text-decoration: none; color: aliceblue;"> <span
                                    style="letter-spacing: 3px; font-weight: 700;">
                                    <small>GET FLAT 20% OFF ON PURCHASE OF RS.4999.</small>
                                </span></a>
                            <a href="#" class="link-light"><span style="font-size: 14px; font-weight: 400;">
        ...
        <div class="row p-4 sticky-top bg-white">
            ...
            <div class="col align-middle img-fluid">
                <a data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                    <svg viewBox="0 0 32 32" width="35px" height="34px" cursor="pointer"
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                    ...
                    <div class="offcanvas-header">
                        <a href="sign.html" style="text-decoration: none;">
                            <h5 class="offcanvas-title" id="offcanvasExampleLabel"><svg
                    ...
                    <div class="offcanvas-body">
                        <div class="offcanvas-body" id="hambur">
                            <ul class="text-uppercase">
                                <li>Best Selling</li>
                                <li>Snitch LUXE</li>
                                <li>Snitch PLUS</li>
                                <!-- Wrap the accordion in a list item to maintain proper structure -->
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="list-unstyled">
                                                    <li><a class="dropdown-item" href="#"><small>Action</small></a></li>
                                                    <li><a class="dropdown-item" href="#"><small>Another
                                                                action</small></a></li>
                                                    <li><a class="dropdown-item" href="#"><small>Something else
                                                                here</small></a>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <ul class="row" style="padding-left: 0px;">
                                <li class="col-md-4" style="padding: 12px 30px;"><a href="#"
            ...
            <div class="col text-center">
                <a href="Huemic.php"><img src="pic/brand1.png" class="img-fluid" alt="Huemic" id="logo"></a>
            </div>
            ...
            <div class="col text-end align-middle">
                ...
                <small>
                    <a href="" class="p-1 g-col-3 link-underline link-underline-opacity-0"
                        ...
                        <svg data-name="Design Convert" id="Design_Convert" viewBox="0 0 64 64"
                            xmlns="http://www.w3.org/2000/svg" height="34px" width="35px">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill: #010101;
                ...
                <small>
                    ...
                    <a href="" class="p-1 g-col-3 link-underline link-underline-opacity-0"
                        style="text-decoration: none;">
                        <svg style="enable-background:new 0 0 64 64;" version="1.1"
                            viewBox="0 0 64 64" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" height="34px" width="35px">
                            <style type="text/css">
                                .st0 {
                                    fill: #231F20;
                                }
    ...
    <div class="container position-relative" id="main">
        <div class="position-absolute top-50 start-50 translate-middle" id="login">
            <small class="text-center">
                ...
                <span><small>A 6 digit OTP will be sent to your email address</small></span>
            </small>
        </div>
    </div>
